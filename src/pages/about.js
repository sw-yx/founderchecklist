          ...
          <div className="post-head-wrap">
            ...
            <div className="post-head-content">
              ...
              <p>
                ...
                organize and catalog these resources into a site so it can be of
                help to others in the design community.
              </p>{' '}
            </div>
            <img
        ...
        <div className="page-about">
          ...
          <div className="page-about-wrap">
            ...
            <div className="about-credits">
              ...
              <h2>Credits</h2>{' '}
              <p>
                Design Systems Repo was designed in the browser using HTML, CSS,
                and Javascript and coded in{' '}
                <a href="https://www.sublimetext.com/">💻 Sublime Text</a>. I'm
                using <a href="https://jekyllrb.com/">🌡 Jekyll</a> to compile
                the site's markdown content into a static site. This is the
                first time I've used Jekyll, so I'm still learning it and
                working through a few issues. The site is uploaded on{' '}
            ...
            <div className="about-connect">
              ...
              <ul>
                {' '}
                <li>
                  <a className="twitter" href="https://twitter.com/jadlimcaco/">
                    <svg
                      version="1.1"
                      id="Layer_1"
